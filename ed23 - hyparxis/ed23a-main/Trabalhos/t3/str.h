...
//   16abr usa tipo 'chu' para representar caracteres unicode 
//         explicita que caracteres são unicode na descrição das funções
//         adição de função para acesso à representação UTF8 da string
